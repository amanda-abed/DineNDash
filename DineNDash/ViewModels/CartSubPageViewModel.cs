...
{
    public class CartSubPageViewModel : BindableBase, INavigationAware
    {
        ...
        public CartSubPageViewModel(INavigationService navigationService, IRepository repository, IPageDialogService pageDialogService)
        {
