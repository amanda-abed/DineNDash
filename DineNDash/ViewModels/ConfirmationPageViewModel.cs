...
namespace DineNDash.ViewModels
{
    public class ConfirmationPageViewModel : BindableBase, INavigationAware
    {
        ...
        public DelegateCommand<OrderItem> RateExperience { get; set; }
        public DelegateCommand<OrderItem> AnotherOrder { get; set; }
        ...
        public ConfirmationPageViewModel(IPageDialogService pageDialogService, INavigationService navigationService, IRepository repository)
        {
            ...
            RateExperience = new DelegateCommand<OrderItem>(GoToRate);
            AnotherOrder = new DelegateCommand<OrderItem>(GoToHomePage);
        }

        private async void GoToHomePage(OrderItem listOfItems)
        {
        ...
        private async void GoToRate(OrderItem listOfItems)
        {
